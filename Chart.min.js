...
f,n,g)));this.ctx.font=m.tooltips.fontStyle+" "+m.tooltips.fontSize+" "+m.tooltips.fontFamily;this.ctx.fillStyle=m.tooltips.fontColor;this.ctx.textAlign="center";this.ctx.textBaseline="middle";this.ctx.fillText(e,d+n/2,f+g/2);this.x=b;this.y=c}},n=v.canvas.width,u=v.canvas.height;this.savedState=null;(('ontouchstart' in window) || window.DocumentTouch && document instanceof DocumentTouch)?(v.canvas.ontouchstart=function(a){a.clientX=a.targetTouches[0].clientX;a.clientY=a.targetTouches[0].clientY;J(a)},v.canvas.ontouchmove=function(a){a.clientX=a.targetTouches[0].clientX;a.clientY=
